...
//   // Handle audio stop: send to Whisper, get text
...
//       // form.append('language', 'ko'); // 언어 지정 시
...
//   // Final handleSend integrating voice override and debate logic
//   const handleSend = (overrideText) => {
//     const content = overrideText ?? userInput;
//     if (!content.trim() || !isDiscussionActive) return;
//     const newMsg = { sender: "User", content, stance: userStance };

//     // Add to chat display and round messages
//     setMessages((prev) => [...prev, newMsg]);
//     setAllRoundsMessages((prev) => {
//       const up = [...prev];
//       const roundStartIdx = { 1: 0, 2: 2, 3: 8 };
...
//     // Reset input and turn state
//     setUserInput("");
//     setIsUserTurn(false);

//     // If round 3, show opponent's pre-generated message then voting
//     if (currentRound === 3) {
//       if (userStance === "찬성" && round3OpponentMessage) {
//         setMessages((prev) => [...prev, round3OpponentMessage]);
//         setAllRoundsMessages((prev) => [...prev, round3OpponentMessage]);
...
//       setIsDiscussionActive(false);
//     } else {
//       // Advance turns in rounds 1 and 2
//       advanceTurn({ 1: 2, 2: 6, 3: 2 });
//     }
//   };
...
//         `${previousMessage ? previousMessage.content : "첫 발언"}\n\n` +
//         `당신의 모든 답변은 ${topic}에 대해서 ${stance} 입장에서 대화해주세요. ` +
...
//         const threshold = 50; // 소리 크기 임계값
//         const silenceDuration = 1500; // 침묵으로 간주할 시간 (ms)

//         const checkAudio = () => {
//           analyserRef.current.getByteFrequencyData(dataArray);
//           const volume = Math.max(...dataArray);

//           if (volume > threshold && !isRecording && isUserTurn) {
